...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const boxPad = {
            ...
            md: "px-6 py-3 text-base font-bold rounded-lg",
            lg: "px-8 py-4 text-lg font-bold rounded-lg",
            icon: "p-3 rounded-lg",
        };
        ...
        const variantStyles = {
            ...
            primary: cn("btn-roll rounded-sm bg-primary text-white duration-300", primaryPad[size]),
