          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="relative order-1 lg:order-2 w-full max-w-[26rem] sm:max-w-[34rem] lg:max-w-none mx-auto lg:mx-0 lg:ml-auto">
              ...
              <div className="relative h-[300px] md:h-[450px]">
                ...
                >
                  <Image
                    src="https://images.pexels.com/photos/36764792/pexels-photo-36764792.jpeg?auto=compress&cs=tinysrgb&w=2000"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="relative order-1 lg:order-1 w-full max-w-[26rem] sm:max-w-[34rem] lg:max-w-none mx-auto lg:mx-0 lg:mr-auto">
              ...
              <div className="relative h-[300px] md:h-[450px]">
                ...
                >
                  <Image
                    src="https://images.pexels.com/photos/2102416/pexels-photo-2102416.jpeg?auto=compress&cs=tinysrgb&w=2000"
                ...
                >
                  <Image
                    src="https://images.pexels.com/photos/3760604/pexels-photo-3760604.jpeg?auto=compress&cs=tinysrgb&w=2000"
