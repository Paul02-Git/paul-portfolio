...
const serviceSchema = {
    ...
    "description": "Professional WordPress development, Elementor customization, GoHighLevel automation, and web development services for businesses worldwide.",
    "provider": {
        "@type": "Person",
        "name": "Paul Puzon",
        "url": siteUrl
        ...
        "itemListElement": [
            {
                ...
                "itemOffered": {
                    ...
                    "description": "Custom WordPress website development with Elementor page builder. Responsive designs, custom themes, and plugin integration."
                }
            },
            {
                "@type": "Offer",
                "itemOffered": {
                    "@type": "Service",
                    "name": "GoHighLevel Specialist",
                    "description": "GoHighLevel CRM setup, automation workflows, email and SMS campaigns, and marketing funnel creation."
                }
            },
            {
                "@type": "Offer",
                "itemOffered": {
                    ...
                    "description": "Full-stack web development services including frontend and backend development, API integrations, and custom solutions."
                }
            },
            {
                "@type": "Offer",
                "itemOffered": {
                    ...
                    "description": "Technical virtual assistant services for WordPress management, website maintenance, and administrative tasks."
                }
            }
        ]
    }
